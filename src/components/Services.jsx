    ...
    <div className="bg-primary py-10 mt-[50px] text-white">
      ...
      <div className="flex justify-around flex-wrap gap-8 px-4">
        ...
        <div className="flex flex-col items-center text-center max-w-xs">
          ...
          <p>
            Order your favorite dishes online quickly and easily through our
            website.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center max-w-xs">
          ...
          <p>
            Get hot and fresh meals delivered straight to your doorstep, fast
            and reliable.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center max-w-xs">
          ...
          <p>
            Tailored catering for your events and celebrations with delicious
            menu options.
          </p>
        </div>
      </div>
